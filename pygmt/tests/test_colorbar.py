...
def test_colorbar_using_paper_coordinates():
    """Create colorbar positioned at 0cm,0cm with length 1cm and width
    0.5cm."""
    fig = Figure()
...
def test_colorbar_box_with_clearance():
    """Create colorbar with box that has an x-clearance of 0.8cm and
    y-clearance of 0.4cm."""
    fig = Figure()
...
def test_colorbar_box_with_secondary_border():
    """Create colorbar with box that has a secondary, inner border in addition
    to the main primary, outer border."""
    fig = Figure()
